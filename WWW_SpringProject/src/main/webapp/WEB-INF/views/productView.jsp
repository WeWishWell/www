		...
		<div class="list_item_category">
			<ul>
				<li id="category1" class=""><a href="?category=all"
					data-label="전체"> <span><img id="category1_image"
							src="resources/images/icon_cate015001.png" alt=""></span> <span>전체</span>
				</a></li>

				<li id="category2" class=""><a href="?category=스킨,미스트" class=""
					data-label="스킨·미스트"> <span><img id="category2_image"
							src="resources/images/icon_cate015001001.png" alt=""></span><span>스킨·미스트
							<em>(4)</em>
					</span>
				</a></li>

				<li id="category3" class=""><a href="?category=세럼,에센스" class=""
					data-label="세럼·에센스"> <span><img id="category3_image"
							src="resources/images/icon_cate015001002.png" alt=""></span><span>세럼·에센스
							<em>(4)</em>
					</span>
				</a></li>

				<li id="category4" class=""><a href="?category=로션,크림" class=""
					data-label="로션·크림"> <span><img id="category4_image"
							src="resources/images/icon_cate015001003.png" alt=""></span><span>로션·크림
							<em>(6)</em>
					</span>
				</a>
				<li id="category5" class=""><a href="?category=마스크,패드,마사지"
					class="" data-label="마스크·패드·마사지"> <span><img
							id="category5_image"
							src="resources/images/icon_cate015001004.png" alt=""></span><span>마스크·패드·마사지
							<em>(4)</em>
					</span>
				</a>
				<li id="category6" class=""><a href="?category=선케어" class=""
					data-label="선케어"> <span><img id="category6_image"
							src="resources/images/icon_cate015001005.png" alt=""></span><span>선케어
							<em>(4)</em>
					</span>
				</a></li>


				<li id="category7" class=""><a href="?category=클렌징" class=""
					data-label="클렌징"> <span><img id="category7_image"
							src="resources/images/icon_cate015001007.png" alt=""></span><span>클렌징
							<em>(4)</em>
					</span>
				</a></li>
