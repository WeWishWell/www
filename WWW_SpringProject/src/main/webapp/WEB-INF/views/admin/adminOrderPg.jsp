...
<script>
  ...
  //페이지 번호 클릭
	function fn_pagination(page, range, rangeSize, searchType, keyword) {
		var url = window.location.href.split('page')[0];
		if(url.includes('?')){
			if(window.location.href.split('page')[0].split('endDate=')[1] == '') {
				url = url + "&page=" + page;
			} else {
				url = url + "page=" + page;
			}
   ...
   <div class="pb-5">
      <div class="container">
         <div class="row" style="margin-top: 22">
            ...
            <!-- 검색창 -->
            <form action="pgGetOrderList" method="get">
            <div class="container">
            <div class="row">
			    ...
			    <div class="input-group mb-3" style="width: 600px;">
				  	...
				  	<button type="button" class="btn btn-secondary" onclick="location.href='pgGetOrderList'">
				    	초기화 
				  	</button>
				</div>
			</div>
